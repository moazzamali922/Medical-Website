			...
			<div class="row">
				...
				<div class="col-md-8 col-lg-12 mt-4 mt-md-0 mb-5">
					...
					<div class="service-img">
						<img src="images/new1.png" class="img-fluid" alt="">
					</div>
					<div class="pt-2 pt-md-4">
						<p>We understand that traveling to a clinic can be challenging for some patients. That's why we
							offer comprehensive home visit services, providing quality healthcare in the comfort of your
							own home. Our experienced and compassionate doctors are equipped to handle a range of
							medical needs, from routine check-ups to chronic illness management. Whether you're dealing
							with mobility issues, post-surgery recovery, or simply prefer the convenience of home care,
							we're here to ensure you receive the best possible treatment. Trust us to bring exceptional
							healthcare to your doorstep, prioritizing your well-being and peace of mind.
						</p>

						<div class="mt-3 mt-lg-6"></div>
						<h3>Convenient Home Visit Medical Care</h3>
						<div class="mt-0 mt-lg-4"></div>
						<p>Experience the ease and comfort of receiving quality medical care at home. Our skilled
							doctors provide a wide range of services, from routine check-ups to chronic illness
							management, ensuring you receive personalized care without the need to travel. Your health
						...
						<div class="mt-0 mt-lg-4"></div>
						<p>Our home visit services bring professional medical care directly to you. Whether you need
					...
					<div class="row">
						<div class="col-md-6">
							<div class="service-img mt-5 mb-5">
								<img src="images/homecare3.png" class="img-fluid" alt="">
							</div> 
						</div>
						<div class="col-md-6">
							<div class="service-img mt-5 mb-5">
