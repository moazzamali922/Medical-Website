...
<div class="page-content">
    ...
    <div class="mt-3 btn-group_custom" role="group" aria-label="Basic outlined example">
        <a href="apply_jobs"
            class="btn-career <?php echo $currentPage == 'apply_jobs' ? 'active-button' : ''; ?>">Career Form</a>
        <a href="client.php" class="btn-client <?php echo $currentPage == 'client' ? 'active-button' : ''; ?>">Client
            Form</a>
    </div>
    ...
    <div class="section page-content-first">
        <div class="container">
            <div class="title-wrap text-center position-relative">
                <div class="h-sub theme-color">Fill Your Client Form</div>
                <h1>Client Form</h1>
                <div class="h-decor"></div>
                <div class="title-button-right"><a href="#" class="btn"><i class="icon-right-arrow"></i><span><img
                                src="images/paypal-logo.png" alt="">&nbsp;Client Form</span><i
                            class="icon-right-arrow"></i></a></div>
            </div>
            ...
            <div class="form-container">
                <form action="backend/client-form.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control mb-3" name="full-name" placeholder="Full Name"
                                required>
                    ...
                    <div class="form-row">
                        <div class="col">
                            <h6>Upload CV</h6>
                            <input type="file" class="form-control-file mb-3" name="cv-file[]" accept=".pdf,.doc,.docx"
                                required>
